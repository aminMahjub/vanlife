  ...
  return (
    <main>
      ...
      <section className="px-7 pt-16 pb-14">
        <div className="mb-14">
          <p className="font-inter-bold text-4xl text-app-text-secondary mb-8">
        ...
        <div className="w-full px-9 py-8 bg-secondary-color rounded-md">
          <div className="text-app-text-secondary text-2xl font-inter-bold">
          ...
          <Link
            to="/vans"
            className="inline-block mt-6 text-pure-white rounded-xl bg-btn-selected-bg-2 text-center p-3 font-inter-bold text-base"
          >
            Explore our Vans
          </Link>
        </div>
